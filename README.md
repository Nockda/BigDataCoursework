...
- Term Frequency (count) of the term in the document o The length of the document (in terms)
- The average document length in the corpus (in terms) o The total number of documents in the corpus
